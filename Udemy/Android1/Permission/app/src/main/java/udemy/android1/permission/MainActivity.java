package udemy.android1.permission;
        ...
        btnPermissions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(MainActivity.this, "Permisssion granted! Thank you!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        if(requestCode==UNIQUE_REQUEST_CODE){
            if(grantResults[0]==PackageManager.PERMISSION_GRANTED){
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    dialog.setMessage("This permission is important to save a file to phone! Please permit it!").setTitle("Important permission required!");
